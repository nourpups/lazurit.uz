<!-- Pop Out Modal -->
<div class="modal fade" id="modal-popout-make_admin<?php echo e($user->id); ?>" tabindex="-1" aria-labelledby="modal-popout"
    ...
    <div class="modal-content">
      <div class="block-rounded mb-0 block shadow-none">
        ...
        <div class="block-content block-content-full block-content-sm border-top text-end">
          ...
          <a href="<?php echo e(route('user.make_admin', $user)); ?>" class="btn btn-alt-primary">
            Yes, make
          </a>
        </div>
      </div>
...
<?php /**PATH C:\OSPanel\domains\lazurit\resources\views/manager/modals/users/make_admin.blade.php ENDPATH**/ ?>