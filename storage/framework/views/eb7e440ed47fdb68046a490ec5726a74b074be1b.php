         ...
         <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
               <div class="map pt-120" data-aos="fade-up" data-aos-delay="200">
                  <iframe
                     title='<?php echo e(__("Our Location")); ?>: <?php echo e(__("Bunyodkor 15/1 street")); ?> <?php echo e(__("Chilonzor district, Tashkent")); ?>, <?php echo e(__("Orientation")); ?>: Bunyodkor "Oltin Markazi"'
