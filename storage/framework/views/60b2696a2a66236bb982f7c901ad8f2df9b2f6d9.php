<?php $__env->startSection('title',$category->name . ' | ' . __('Catalog') ." | ". __('Jewelry brand «Lazurit» - jewelry made of precious metals and stones')); ?>
   ...
   <div class="breadcrumb-area bg-gray-4 breadcrumb-padding-1">
      <div class="container">
         <div class="breadcrumb-content text-center">
            <h2 data-aos="fade-up" data-aos-delay="200"><?php echo e($category->name); ?></h2>
            ...
            <div class="col-12">
               <div class="shop-topbar-wrapper mb-40">
                  ...
                  <div class="shop-topbar-right" data-aos="fade-up" data-aos-delay="400">
                     <form method="GET" action="<?php echo e(route('catalog', $category)); ?>" id="sort_form">
                        <div class="shop-sorting-area-my">
                           <select name="sort" id="sort_catalog">
                              <option <?php echo e(request('sort') == 'relevance' ? 'selected': ''); ?> value="relevance">
                                 <?php echo e(__('Relevance')); ?>

                              </option>
                              <option <?php echo e(request('sort') == 'asc' ? 'selected': ''); ?> value="asc">
                                 <?php echo e(__('Name (A-Z)')); ?>

                              </option>
                              <option <?php echo e(request('sort') == 'desc' ? 'selected': ''); ?> value="desc">
               ...
               <div class="shop-bottom-area">
                  <div class="tab-content jump">
                     <div id="shop-1" class="tab-pane active">
                        ...
                        <?php echo e($products->WithQueryString()->links('pagination::bootstrap-4-catalog')); ?>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\lazurit\resources\views/catalog/catalog.blade.php ENDPATH**/ ?>