<?php $__env->startSection('title', __('Contact Us'). " | " .__('Jewelry brand «Lazurit» - jewelry made of precious metals and stones')); ?>
  ...
  <div class="breadcrumb-area bg-gray-4 breadcrumb-padding-1">
      <div class="container">
          <div class="breadcrumb-content text-center">
              <h2 data-aos="fade-up" data-aos-delay="200"><?php echo e(__('Contact Us')); ?></h2>
  ...
  <div class="contact-us-area pt-50 mb-30">
          <div class="container">
              <div class="section-title-4 text-center mb-50" data-aos="fade-up" data-aos-delay="200">
                  <h2><?php echo e(__('Our Outlet Address')); ?></h2>
              </div>
              <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-6 col-12 d-flex justify-content-center align-items-center">
                      <div class="contact-us-info-wrap mb-30" data-aos="fade-up" data-aos-delay="200">
                          ...
                          <div class="contact-us-info">
                              <p><?php echo e(__('Bunyodkor 15/1 street')); ?>, <?php echo e(('Chilonzor district, Tashkent')); ?></p>
                              <p><?php echo e(__('Orientation')); ?> : Bunyodkor "Oltin Markazi"</p>
                              <span><?php echo e(__('Telephone Enquiry')); ?> : <a href="tel:+998900977020">+998900977020</a></span>
                          </div>
                          <div class="open-time">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                      <div class="map pt-120" data-aos="fade-up" data-aos-delay="200">
                          <iframe title='<?php echo e(__("Our Location")); ?>: <?php echo e(__("Bunyodkor 15/1 street")); ?> <?php echo e(__("Chilonzor district, Tashkent")); ?>, <?php echo e(__("Orientation")); ?>: Bunyodkor "Oltin Markazi"' src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3118.1173125877754!2d69.22374691886017!3d41.29238199084395!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x38ae8a4c6b819a5d%3A0x47032473c74b43!2z0JPQvtC70LQg0KbQtdC90YLRgA!5e1!3m2!1sru!2s!4v1677096770093!5m2!1sru!2s" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\lazurit.uz\resources\views/landing/contact.blade.php ENDPATH**/ ?>