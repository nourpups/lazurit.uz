                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="d-none d-sm-table-cell">
                              ...
                              <a class="btn btn-alt-primary mb-2 w-100" href="<?php echo e(route('category.edit', $cat)); ?>"> <i class="fa fa-pen"></i> Edit
                              </a>

                                <button type="button" class="btn btn-danger mb-2 w-100" data-bs-toggle="modal"
                                    data-bs-target="#modal-popout-delete<?php echo e($cat->id); ?>"><i class="fa fa-trash"></i> Delete
                                </button>
