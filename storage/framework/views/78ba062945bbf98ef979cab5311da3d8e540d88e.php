              ...
              <div id="lg2" class="tab-pane active">
                <div class="login-form-container">
                  <div class="login-register-form">
                    <form method="POST" action="<?php echo e(route('register')); ?>" id="auth_form">
                      <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\lazurit.uz\resources\views/auth/register.blade.php ENDPATH**/ ?>