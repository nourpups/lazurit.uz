          ...
          <div class="block-content block-content-full d-flex align-items-center justify-content-between">
            <div class="me-1">
              <p class="fs-lg fw-semibold mb-0 text-white">
                <?php echo e($products_count); ?> Products
              </p>
      ...
      <div class="col-6 col-xl-3">
        <a class="block-rounded bg-black-90 block shadow-none" href="<?php echo e(route('orders')); ?>">
          <div class="block-content block-content-full d-flex align-items-center justify-content-between">
            <div class="me-1">
              <p class="fs-lg fw-semibold mb-0 text-white">
                <?php echo e($orders_count); ?> Orders
              </p>
              <p class="fs-sm text-uppercase fw-semibold text-white-75 mb-0">
                Total Orders
              </p>
        ...
        <div class="block-rounded bg-gd-emerald block text-white">
          <div class="block-content">
            <div class="py-3 text-center">
              ...
              <h2 class="h5 fw-medium">Total Products: <?php echo e($products_count); ?></h2>
            </div>
          </div>
        </div>
          ...
          <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-6 col-md-4 col-xl-3">
              <a class="block-rounded bg-image block text-center"
                style="background-image: url(<?php echo e(asset("storage/$category->image")); ?>); " href="javascript:void(0)">
        ...
        <div class="block-rounded bg-gd-dusk block text-white">
          <div class="block-content">
            <div class="py-3 text-center">
              ...
              <h2 class="h5 fw-medium">Total Users: <?php echo e($users_count); ?></h2>
            </div>
          </div>
        </div>
        <div class="row">
    ...
    <div class="block-rounded bg-black-90 block text-white">
      <div class="block-content">
        <div class="py-3 text-center">
          ...
          <h2 class="h5 fw-medium">Total Orders: <?php echo e($orders_count); ?></h2>
        </div>
      </div>
    </div>
    <div class="row justify-content-center">
      ...
      <div class="col-6 col-xl-3">
        <a class="block-rounded bg-black-50 block shadow-none" href="javascript:void(0)">
          <div class="block-content block-content-full d-flex align-items-center justify-content-between">
            <div class="me-1">
              <p class="fs-lg fw-semibold mb-0 text-white">
                <?php echo e($today_orders); ?> Orders
              </p>
              <p class="fs-sm text-uppercase fw-semibold text-white-75 mb-0">
                Today Orders
              </p>
      ...
      <div class="col-6 col-xl-3">
        <a class="block-rounded bg-black-75 block shadow-none" href="javascript:void(0)">
          <div class="block-content block-content-full d-flex align-items-center justify-content-between">
            <div class="me-1">
              <p class="fs-lg fw-semibold mb-0 text-white">
                <?php echo e($this_week_orders); ?> Orders
              </p>
              <p class="fs-sm text-uppercase fw-semibold text-white-75 mb-0">
                This Week Orders
              </p>
      ...
      <div class="col-6 col-xl-3">
        <a class="block-rounded block bg-black shadow-none" href="javascript:void(0)">
          <div class="block-content block-content-full d-flex align-items-center justify-content-between">
            <div class="me-1">
              <p class="fs-lg fw-semibold mb-0 text-white">
                <?php echo e($this_month_orders); ?> Orders
              </p>
              <p class="fs-sm text-uppercase fw-semibold text-white-75 mb-0">
                This Month Orders
              </p>
