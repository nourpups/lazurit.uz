         ...
         <div class="block block-rounded shadow-none mb-0">
            ...
            <div class="block-content fs-sm">
               ...
               <table class="table  table-striped table-vcenter js-dataTable-full">
                  ...
                  <div class="row p-3">
                     <div class="col-6">
                        Customer Name: <h5><?php echo e($order->user->name); ?></h5>
                     </div>
                     <div class="col-6">
                        Customer Phone: <h5><a href="tel:<?php echo e($order->user->phone); ?>"><?php echo e($order->user->phone); ?></a></h5>
                     </div>
                     <div class="col-6">
                        Confirmed At: <h5><?php echo e($order->created_at); ?></h5>
                     </div>
                     <div class="col-6">
...
<?php /**PATH /var/www/resources/views/manager/modals/orders/show.blade.php ENDPATH**/ ?>