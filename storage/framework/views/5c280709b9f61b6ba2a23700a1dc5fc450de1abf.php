            ...
            <div class="content-side content-side-full">
               <ul class="nav-main">
                  ...
                  <li class="nav-main-item">
                     <a class="nav-main-link" href="<?php echo e(route('manager.index')); ?>">
                        <i class="nav-main-link-icon fa-solid fa-chart-pie"></i>
                        <span class="nav-main-link-name">Dashboard</span>
                     </a>
                     <a class="nav-main-link" href="<?php echo e(route('users.index')); ?>">
                     ...
                     <a class="nav-main-link" href="<?php echo e(route('categories.index')); ?>">
...
<?php /**PATH /var/www/resources/views/manager/layouts/manager.blade.php ENDPATH**/ ?>