<!-- Pop Out Modal -->
<div class="modal fade" id="modal-popout-delete<?php echo e($cat->id); ?>" tabindex="-1" aria-labelledby="modal-popout" style="display: none;"
    aria-hidden="true">
    <form action="<?php echo e(route('category.delete', $cat->id)); ?>" method="post">
        <?php echo csrf_field(); ?>
