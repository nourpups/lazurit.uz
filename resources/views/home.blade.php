   ...
   <div class="slider-area">
      <div class="container-fluid">
         <div
            ...
            style="background-image:url({{ asset('assets/images/slider/home-banner-5.webp') }});  background-size: contain; background-repeat: no-repeat;">
            <div class="container">
               <div class="row align-items-start">
                  <div class="col-lg-5 offset-lg-7 offset-6 col-6">
                     <div class="slider-content-1 slider-animated-1 ms-lg-5 ms-md-4">
                        <h1 class="animated text-white">{{ __('Ignite Your Dreams') }}</h1>
                        <div class="slider-btn btn-hover">
                           <a href="{{ route('catalog', $bracelets) }}" class="btn animated">
                              {{ __('Show Bracelets') }} <i class="ti-arrow-right"></i>
                           </a>
                        </div>
                     </div>
                  </div>
         ...
         <div class="bg-img bg-padding-3"
            ...
            <div class="banner-content-5 banner-content-5-static banner-content-5-home">
               <h1 class="font-montserrat" data-aos="fade-up"
                   data-aos-delay="400">{{ __('Celebrate all the love') }}</h1>
               <p data-aos="fade-up"
                  data-aos-delay="600">{{ __('We have the perfect gift for everyone you cherish') }} </p>
               <div class="btn-style-3 btn-hover" data-aos="fade-up" data-aos-delay="800">
                  <a class="btn border-radius-none"
                     href="{{ route('catalog',  $sets) }}">{{ __('Show Gifts') }}</a>
               </div>
            </div>
         </div>
      </div>
