...
<head>
  ...
  <link rel="icon" type="image/png" sizes="192x192"
    href="{{ asset('manager_assets/media/favicons/favicon-192x192.png') }}">
  <link rel="apple-touch-icon" sizes="180x180"
    href="{{ asset('manager_assets/media/favicons/apple-touch-icon-180x180.png') }}">
  <!-- END Icons -->
    ...
    <aside id="side-overlay">
      ...
      <div class="content-header">
        ...
        <a class="img-link me-2" href="be_pages_generic_profile.html">
          <img class="img-avatar img-avatar32" src="{{ asset('manager_assets/media/avatars/avatar15.jpg') }}"
            alt="">
        </a>
        <!-- END User Avatar -->
        ...
        <div class="pull-x block">
          ...
          <div class="block-content">
            <ul class="nav-users">
              ...
              <li>
                <a href="be_pages_generic_profile.html">
                  <img class="img-avatar" src="{{ asset('manager_assets/media/avatars/avatar11.jpg') }}"
                    alt="">
                  <i class="fa fa-circle text-success"></i>
                  <div>Carl Wells</div>
              ...
              <li>
                <a href="be_pages_generic_profile.html">
                  <img class="img-avatar" src="{{ asset('manager_assets/media/avatars/avatar7.jpg') }}"
                    alt="">
              ...
              <li>
                <a href="be_pages_generic_profile.html">
                  <img class="img-avatar" src="{{ asset('manager_assets/media/avatars/avatar10.jpg') }}"
                    alt="">
                  <div>Ryan Flores</div>
          ...
          <div class="content-side content-side-user px-0 py-0">
            ...
            <div class="smini-visible-block animated fadeIn px-3">
              <img class="img-avatar img-avatar32"
                src="{{ asset('manager_assets/media/avatars/nourpack_legend.png') }}" alt="">
            </div>
            ...
            <div class="smini-hidden mx-auto text-center">
              <a class="img-link" href="{{ route('home') }}" target="_blank">
                <img class="img-avatar" src="{{ asset('manager_assets/media/avatars/nourpack_legend.png') }}"
                  alt="">
              </a>
              <ul class="list-inline mt-3 mb-0">
                <li class="list-inline-item">
                  <a class="text-dual fs-sm fw-semibold text-uppercase" href="{{ route('home') }}">Lazurit</a><span
