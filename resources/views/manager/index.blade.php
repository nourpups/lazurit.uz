   ...
   <div class="container py-3">
      ...
      <div class="row">
         ...
         <div class="col-6 col-xl-3">
            <a class="block-rounded bg-gd-emerald block shadow-none" href="{{ route('products.index') }}">
         ...
         <div class="col-6 col-xl-3">
            <a class="block-rounded bg-gd-cherry block shadow-none" href="{{ route('categories.index') }}">
               <div class="block-content block-content-full d-flex align-items-center justify-content-between">
                  <div class="me-1">
                     <p class="fs-lg fw-semibold mb-0 text-white">
         ...
         <div class="col-6 col-xl-3">
            <a class="block-rounded bg-gd-dusk block shadow-none" href="{{ route('users.index') }}">
               <div class="block-content block-content-full d-flex align-items-center justify-content-between">
                  <div class="me-1">
                     <p class="fs-lg fw-semibold mb-0 text-white">
